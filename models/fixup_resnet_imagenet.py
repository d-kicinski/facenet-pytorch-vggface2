...
__all__ = ["FixUpResnet18Triplet", 'FixupResNet', 'fixup_resnet18', 'fixup_resnet34', 'fixup_resnet50',
           'fixup_resnet101', 'fixup_resnet152']


class FixUpResnet18Triplet(nn.Module):
    ...
    def __init__(self, embedding_dimension=512):
        super(FixUpResnet18Triplet, self).__init__()

        self.model = fixup_resnet18()
